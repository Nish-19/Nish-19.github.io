...
We will use Pytorch and HuggingFace for running BERT. It is very unlikely that you haven’t heard about HuggingFace. HuggingFace is a NLP startup which release open source NLP state-of-the-art models which can be used by anyone. These models run with the support of deep learning libraries like Pytorch or Tensorflow 2.0.
